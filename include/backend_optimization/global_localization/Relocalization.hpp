...
public:
    ...
    void set_gicp_param(bool _use_gicp, const double &_filter_range, const double &gicp_ds, const double &search_radi, const double &tep, const double &fep, const double &fit_score)
    {
        use_gicp = _use_gicp;
...
private:
    ...
    bool run_gnss_relocalization(PointCloudType::Ptr scan, Eigen::Matrix4d &rough_mat, const double &lidar_beg_time, const Eigen::Matrix4d &lidar_ext, double &score)
    {
        Timer timer;
